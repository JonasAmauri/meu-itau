                ...
                <div className="flex-1 max-w-[594px] pt-32">
                    ...
                    <ul className="flex flex-col items-start gap-9">
                        ...
                        <li className="flex items-center gap-9" >
                            ...
                            <p className="flex-1 text-txt-gray pr-2">Acompanhe a fatura de seu cartão de crédito e faça compras anline com seu cartão virtual</p>
                        </li>
                    </ul>
                </div>
            </Container>
